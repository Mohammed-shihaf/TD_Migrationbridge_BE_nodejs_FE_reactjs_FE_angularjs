...
| CC7.1 (Change detection) | Branch = `migrationbridge_BE_nodejs22_FE_reactjs22_FE_angularjs17`, Node.js 22.x - version and provenance are pinned per branch |
...
This declaration covers the backend service in this branch (`migrationbridge_BE_nodejs22_FE_reactjs22_FE_angularjs17`). It is a repository-level control mapping, not an attestation issued by an auditor.
