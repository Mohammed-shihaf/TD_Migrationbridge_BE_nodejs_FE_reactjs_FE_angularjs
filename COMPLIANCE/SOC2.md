...
| CC7.1 (Change detection) | Branch = `migrationbridge_BE_nodejs20_FE_reactjs24_FE_angularjs19`, Node.js 20.x - version and provenance are pinned per branch |
...
This declaration covers the backend service in this branch (`migrationbridge_BE_nodejs20_FE_reactjs24_FE_angularjs19`). It is a repository-level control mapping, not an attestation issued by an auditor.
